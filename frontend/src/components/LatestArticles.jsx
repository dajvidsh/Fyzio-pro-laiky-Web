...
export default function LatestArticles() {
  ...
  useEffect(() => {
    fetch('https://fyzio-pro-laiky-server.onrender.com/api/articles').then(res => res.json()).then(data => setArticles(data)).catch(err => console.error("Chyba pri nacitani", err));
  }, []);
